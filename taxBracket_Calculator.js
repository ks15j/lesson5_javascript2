        ...
        if (status == 0) { 
         ...
         //0-Single, 1-Married Jointly, 2-Married Separately, and 3-Head of Household
               ...
               if (income <= 19050){
                 ...
                 tax = 19050 * 0.10 + (7740 - 19050) * 0.12 + (income - 77400) * 0.22;
                 taxRate = 22;
               } //end of else if
...
function clearButton () {
              ...
              document.getElementById("filingStatus").selectedIndex = "";
              
             //This code resets the tax estimate calcualtion
             document.getElementById("taxEstimate").value = "";
             
             //This code resets the tax bracket calcualtion
